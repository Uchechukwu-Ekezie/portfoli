...
const ProjectCard: React.FC<{ project: Project; index: number }> = ({ project}) => {
  ...
  return (
    <div className="relative transition-all duration-500 border border-gray-700 rounded-lg group bg-gray-900/50 backdrop-blur-sm hover:bg-gray-800/70 hover:border-yellow-400/30 hover:scale-105 hover:shadow-2xl hover:shadow-yellow-400/10">
      ...
      {/* Orbital ring effect */}
      <div className="absolute inset-0 transition-opacity duration-500 border border-yellow-400 rounded-lg opacity-0 group-hover:opacity-10"
           style={{ 
             margin: '10px',
      ...
      <div className="relative z-10 p-6">
        <div className="flex items-start justify-between mb-4">
          ...
          <span className={`text-xs px-3 py-1 rounded-full border transition-all duration-300 ${getStatusColor(project.status)}`}>
            {project.status}
          </span>
        </div>
            ...
            >
              ...
              {hoveredTech === techIndex && (
                <div className="absolute -top-1 -right-1">
                  <Sparkles size={10} className="text-yellow-400 animate-ping" />
                </div>
              )}
            </span>
          ))}
  ...
  const projects: Project[] = [
    {
      ...
      description: "Built case-control assignment algorithm utilizing clinical, behavioral, and self-report data from over 50 variables. Implemented Random Forest and Logistic Regression models to predict active tuberculosis progression in 1000+ patients from rural South African clinics.",
      technologies: ["Python", "Random Forest", "Logistic Regression", "Clinical Data", "Epidemiology"],
      github: "#",
    ...
    },
    {
      ...
      description: "Leading the first-ever single-cell RNA sequencing analysis of a TB case-control cohort using 10X Genomics. Profiling gene expression and cell surface protein markers in PBMCs to identify novel genetic variants and immune mechanisms driving TB progression.",
      technologies: ["scRNA-seq", "10X Genomics", "Python", "R", "Immunogenetics", "Single Cell"],
      github: "#",
      demo: "https://oyageshio.wixsite.com/oshi-omics/projects",
      status: "Active",
    },
    {
      ...
      description: "Comprehensive immune cell classification and characterization pipeline to uncover disease-specific immune signatures and cell-type-specific responses in tuberculosis patients using advanced computational methods.",
      technologies: ["Python", "R", "Cell Classification", "Immunology", "Machine Learning"],
      github: "#",
      demo: "https://oyageshio.wixsite.com/oshi-omics/projects",
      status: "Active",
    },
    {
      ...
      description: "Conducting differential gene expression analysis to pinpoint key genes and pathways associated with TB susceptibility and progression, utilizing state-of-the-art bioinformatics approaches.",
      technologies: ["R", "Python", "DESeq2", "Pathway Analysis", "Genomics", "Statistics"],
      github: "#",
      demo: "https://oyageshio.wixsite.com/oshi-omics/projects",
      status: "Active",
    },
    {
      ...
      description: "Discovering disease- and ancestry-associated quantitative trait expression loci (eQTLs) to uncover genetic variants influencing immune gene regulation in admixed populations affected by tuberculosis.",
      technologies: ["Python", "R", "eQTL Analysis", "Population Genetics", "GWAS", "Genomics"],
      github: "#",
      demo: "https://oyageshio.wixsite.com/oshi-omics/projects",
      status: "Active",
    },
    {
      ...
      description: "Applying variant effect prediction algorithms to a global genetic dataset of 3000+ individuals from 60 populations. Created consensus ML metric for classifying deleterious genetic variants and identified correlations with evolutionary conservation tools.",
      technologies: ["Python", "Machine Learning", "Variant Analysis", "Population Genetics", "Bioinformatics"],
      github: "#",
      demo: "#",
      status: "Published",
    },
          ...
          <div className="relative">
            ...
            <div className="flex items-center justify-center gap-4 mb-4">
              ...
              <div className="flex space-x-2">
                {[FlaskConical, Microscope, Database].map((Icon, i) => (
                  <Icon 
                    key={i}
                    size={20} 
            ...
            <p className="max-w-3xl mx-auto text-lg text-gray-400">
              Computational biology and bioinformatics research focused on tuberculosis susceptibility, 
              immunogenetics, and population genomics at UC Davis
            </p>
              ...
              {Array.from({ length: 6 }).map((_, i) => (
                ...
                >
                  {[BarChart3, TrendingUp, Globe, Users, Award, Target][i] && 
                    React.createElement([BarChart3, TrendingUp, Globe, Users, Award, Target][i], { size: 24 })
                  }
                </div>
              ))}
            </div>
